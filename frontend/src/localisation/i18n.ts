...
const resources = {
  EN: {
    translation: {
      ...
      usernameRegex: "Lowercase letters, numbers, and underscores only (no uppercase or special characters)",
  ...
  FR: {
    translation: {
      ...
      usernameMaxLength: "Le nom d'utilisateur doit comporter au maximum 12 caractères",
      usernameRegex: "Lettres minuscules, chiffres et underscores uniquement (pas de majuscules ni de caractères spéciaux)",
      usernameStartsWithUnderscore: "Le nom d'utilisateur ne peut pas commencer par un underscore",
  ...
  IT: {
    translation: {
      ...
      usernameRegex: "Solo lettere minuscole, numeri e underscore (niente maiuscole o caratteri speciali)",
      usernameStartsWithUnderscore: "Il nome utente non può iniziare con un underscore",
  ...
  ES: {
    translation: {
      ...
      usernameMaxLength: "El nombre de usuario debe tener como máximo 12 caracteres",
      usernameRegex: "Solo letras minúsculas, números y guiones bajos (no mayúsculas ni caracteres especiales)",
      usernameStartsWithUnderscore: "El nombre de usuario no puede comenzar con un guion bajo",
